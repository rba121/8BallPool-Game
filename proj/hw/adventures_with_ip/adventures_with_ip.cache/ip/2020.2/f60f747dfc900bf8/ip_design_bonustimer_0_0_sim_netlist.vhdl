...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bonustimer_v1_0_S00_AXI is
  ...
  signal timer_value_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of timer_enable_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of timer_reset_i_1 : label is "soft_lutpair2";
...
timer_value: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
timer_value0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3 downto 2) => B"00",
      DI(1) => \^s00_axi_rdata\(2),
      DI(0) => '0',
      O(3 downto 0) => timer_value0(4 downto 1),
      S(3 downto 2) => \^s00_axi_rdata\(4 downto 3),
...
\timer_value0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^s00_axi_rdata\(8 downto 5)
    );
\timer_value0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^s00_axi_rdata\(12 downto 9)
    );
