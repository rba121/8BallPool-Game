...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bonustimer_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of en_sig_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \slv_reg0[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \slv_reg1[13]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of timer_enable_i_1 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of timer_reset_i_1 : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \timer_value[0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \timer_value[10]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \timer_value[11]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \timer_value[12]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \timer_value[13]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \timer_value[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \timer_value[2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \timer_value[3]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \timer_value[4]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \timer_value[5]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \timer_value[6]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \timer_value[7]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \timer_value[8]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \timer_value[9]_i_1\ : label is "soft_lutpair21";
begin
...
\timer_value[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"74"
    )
        port map (
...
\timer_value[10]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[11]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[13]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[13]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FD000000"
    )
        port map (
...
\timer_value[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\timer_value[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
