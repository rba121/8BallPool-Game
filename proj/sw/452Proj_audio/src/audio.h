...
#define RECORDING_DURATION 30 // Maximum recording time in seconds
#define SAMPLE_RATE 48000 // 48kHz audio sample rate
#define MEMORY_SIZE (SAMPLE_RATE * RECORDING_DURATION) // Buffer size
#define CPU_CLOCK_HZ 200000000        // Zynq's CPU clock speed (200 MHz)
#define SAMPLE_PERIOD (CPU_CLOCK_HZ / SAMPLE_RATE) //
extern XTime recording_start_time;
extern XTime recording_end_time;
#define NUM_RECORDINGS 3

// Buffers for storing recorded audio
extern u32 left_channel_buffer[MEMORY_SIZE];
extern u32 right_channel_buffer[MEMORY_SIZE];

// Flag to track recording state
extern int recording;

/* ADAU1761 internal registers */
enum audio_regs {
